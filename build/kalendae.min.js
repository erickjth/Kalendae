...
(function(z){var r,k,n=function(a,b){if("function"===typeof document.addEventListener||e.isIE8()){var c=!1;try{c=a instanceof Element}catch(A){c=!!a&&1===c.nodeType}c||"string"===typeof a||(b=a);var d=this,g=d.classes,f=d.settings=e.merge(d.defaults,{attachTo:a},b||{}),c=d.container=e.make("div",{"class":g.container}),h=d.calendars=[],n=k().day(f.weekStart),m,t=[],p,l,q,u,r;p=[];l=0;m=f.months;e.isIE8()&&e.addClassName(c,"ie8");for(l=7;l--;)t.push(n.format(f.columnHeaderFormat)),n.add(1,"days");y(d);
if("object"===typeof f.subscribe)for(l in f.subscribe)f.subscribe.hasOwnProperty(l)&&d.subscribe(l,f.subscribe[l]);m=f.viewStartDate?k(f.viewStartDate,f.format):k();d.viewStartDate=m.date(1);d._sel=[];f.selected&&(d.setSelected(f.selected,!1),d.viewStartDate=k(d._sel[0]));(m={past:f.months-1,"today-past":f.months-1,any:2<f.months?Math.floor(f.months/2):0,"today-future":0,future:0}[this.settings.direction])&&k().month()==k(d.viewStartDate).month()&&(d.viewStartDate=k(d.viewStartDate).subtract({M:m}).date(1));
d.defaultView=k(d.viewStartDate);if("function"===typeof f.blackout)d.blackout=f.blackout;else if(f.blackout){var x=v(f.blackout,f.parseSplitDelimiter,f.format);d.blackout=function(a){a=k(a).startOf("day").yearDay();if(1>a||!d._sel)return!1;for(var c=x.length;c--;)if(x[c].startOf("day").yearDay()===a)return!0;return!1}}else d.blackout=function(){return!1};d.direction=d.directions[f.direction]?d.directions[f.direction]:d.directions.any;for(m=Math.max(f.months,1);m--;){p=e.make("div",{"class":g.calendar},
c);p.setAttribute("data-cal-index",m);1<f.months&&(m==Math.max(f.months-1,1)?e.addClassName(p,g.monthFirst):0===m?e.addClassName(p,g.monthLast):e.addClassName(p,g.monthMiddle));l=e.make("div",{"class":g.title},p);f.useYearNav||e.addClassName(l,g.disableYearNav);e.make("a",{"class":g.previousYear},l);e.make("a",{"class":g.previousMonth},l);e.make("a",{"class":g.nextYear},l);e.make("a",{"class":g.nextMonth},l);n=e.make("span",{"class":g.caption},l);q=e.make("div",{"class":g.header+" "+(1==f.dayHeaderClickable?
g.dayActive:"")},p);l=0;do u=e.make("span",{"data-day":l},q),1==f.dayHeaderClickable&&"multiple"==f.mode&&(u.addEventListener("mouseover",function(a){daysToHover=a.target.parentNode.nextSibling.getElementsByClassName("k-day-week-"+a.target.getAttribute("data-day"));if(0<daysToHover.length)for(a=0;a<daysToHover.length;a++)e.hasClassName(daysToHover[a],g.dayActive)&&e.addClassName(daysToHover[a],"k-day-hover-active")}),u.addEventListener("mouseleave",function(a){daysToHover=a.target.parentNode.nextSibling.getElementsByClassName("k-day-week-"+
a.target.getAttribute("data-day"));if(0<daysToHover.length)for(a=0;a<daysToHover.length;a++)e.hasClassName(daysToHover[a],g.dayActive)&&e.removeClassName(daysToHover[a],"k-day-hover-active")})),u.innerHTML=t[l];while(7>++l);u=e.make("div",{"class":g.days},p);l=0;p=[];do"week"==f.mode?(0===l%7&&(r=e.make("div",{"class":g.week+" clearfix"},u),p.push(r)),e.make("span",{},r)):p.push(e.make("span",{},u));while(42>++l);h.push({header:q,caption:n,days:p});m&&e.make("div",{"class":g.monthSeparator},c)}d.draw();
e.addEvent(c,"mousedown",function(a,c){var b;if(e.hasClassName(c,g.nextMonth))d.disableNext||!1===d.publish("view-changed",d,["next-month"])||(d.viewStartDate.add(1,"months"),d.draw());else if(e.hasClassName(c,g.previousMonth))d.disablePreviousMonth||!1===d.publish("view-changed",d,["previous-month"])||(d.viewStartDate.subtract(1,"months"),d.draw());else if(e.hasClassName(c,g.nextYear))d.disableNext||!1===d.publish("view-changed",d,["next-year"])||(d.viewStartDate.add(1,"years"),d.draw());else if(e.hasClassName(c,
...
c||b<c&&a<b&&a>c?-1:!1:0;case "multiple":for(b=this._sel.length;b--;)if(this._sel[b].startOf("day").yearDay()===a)return!0;return!1;default:return this._sel[0]&&this._sel[0].startOf("day").yearDay()===a}},setSelected:function(a,b){var c,d=v(a,this.settings.parseSplitDelimiter,this.settings.format),g=v(this.getSelected(),this.settings.parseSplitDelimiter,this.settings.format);for(c=g.length;c--;)this.removeSelected(g[c],!1);for(c=d.length;c--;)this.addSelected(d[c],!1);!1!==b&&(d[0]&&(this.viewStartDate=
k(d[0],this.settings.format)),this.draw())},addSelected:function(a,b){a=k(a,this.settings.format).hours(12);this.settings.dayOutOfMonthClickable&&"range"!==this.settings.mode&&this.makeSelectedDateVisible(a);switch(this.settings.mode){case "multiple":if(this.isSelected(a))return!1;this._sel.push(a);break;case "range":1!==this._sel.length?this._sel=[a]:a.startOf("day").yearDay()>this._sel[0].startOf("day").yearDay()?this._sel[1]=a:this._sel=[a,this._sel[0]];break;default:this._sel=[a]}this._sel.sort(function(a,
b){return a.startOf("day").yearDay()-b.startOf("day").yearDay()});this.publish("change",this,[a]);!1!==b&&this.draw();return!0},weekSelected:function(a){var b=a.toDate(),c=k(b).startOf("week"),b=k(b).endOf("week").subtract(1,"day");this._sel=[c,b];this.publish("change",this,[a.day()]);this.draw()},monthDaySelected:function(a,b,c){b=k(a).startOf("month").weekday(b);var d=k(a).endOf("month");for(selected=[];b<=d;)b>=k(a).startOf("month")&&!this.direction(b)&&(c?this.removeSelected(k(b).hours(12)):this.addSelected(k(b).hours(12))),
b.add(7,"d")},makeSelectedDateVisible:function(a){outOfViewMonth=k(a).date("1").diff(this.viewStartDate,"months");0>outOfViewMonth?this.viewStartDate.subtract(1,"months"):0<outOfViewMonth&&outOfViewMonth>=this.settings.months&&this.viewStartDate.add(1,"months")},removeSelected:function(a,b){a=k(a,this.settings.format).hours(12);for(var c=this._sel.length;c--;)if(this._sel[c].startOf("day").yearDay()===a.startOf("day").yearDay())return this._sel.splice(c,1),this.publish("change",this,[a]),!1!==b&&
this.draw(),!0;return!1},draw:function(){var a=k(this.viewStartDate).startOf("day").add(12,"hours"),b,c=this.classes,d,g,f,h=0,w,m=0;b=0;var t,p,l,q=this.settings;w=this.calendars.length;do{b=k(a).date(1);b.day(b.day()<this.settings.weekStart?this.settings.weekStart-7:this.settings.weekStart);d=this.calendars[h];d.header.parentNode.setAttribute("data-datestart",a.format(this.settings.dayAttributeFormat));d.caption.innerHTML=a.format(this.settings.titleFormat);t=m=0;l=[];for(g=0;7>g;g++)e.removeClassName(d.header.children[g],
c.daySelected),l[g]=0;do"week"==q.mode?(0===m%7&&0!==m&&t++,g=d.days[t].childNodes[m%7]):g=d.days[m],f=[],(p=this.isSelected(b))&&f.push({"-1":c.dayInRange,1:c.daySelected,"true":c.daySelected}[p]),1==q.dayHeaderClickable&&"multiple"==q.mode&&(f.push("k-day-week-"+b.weekday()),1!=p&&1!=p||this.direction(b)||a.format("M")!=b.format("M")||(l[b.weekday()]=l[b.weekday()]+1)),b.month()!=a.month()?f.push(c.dayOutOfMonth):f.push(c.dayInMonth),(!(this.blackout(b)||this.direction(b)||b.month()!=a.month()&&
!1===q.dayOutOfMonthClickable)||0<p)&&f.push(c.dayActive),b.clone().startOf("day").yearDay()===r.yearDay()&&f.push(c.dayToday),p=b.format(this.settings.dayAttributeFormat),q.dateClassMap[p]&&f.push(q.dateClassMap[p]),g.innerHTML=b.format(q.dayNumberFormat),g.className=f.join(" "),g.setAttribute("data-date",p),b.add(1,"days");while(42>++m);g=0;if(0<l.length){do if(0<l[g]){m=n.moment(a).startOf("month").weekday(g);t=n.moment(a).startOf("month");endMonth=n.moment(a).endOf("month");b=0;do m>=t&&!this.direction(m)&&
b++,m.add(7,"d");while(m<=endMonth);b==l[g]?e.addClassName(d.header.children[g],c.daySelected):e.removeClassName(d.header.children[g],c.daySelected)}while(++g<l.length)}a.add(1,"months")}while(++h<w);if(q.directionScrolling){d=k().startOf("day").hours(12);a=a.diff(d,"months",!0);if("today-past"===q.direction||"past"===q.direction)0>=a?(this.disableNextMonth=!1,e.removeClassName(this.container,c.disableNextMonth)):(this.disableNextMonth=!0,e.addClassName(this.container,c.disableNextMonth));else if("today-future"===
q.direction||"future"===q.direction)a>q.months?(this.disablePreviousMonth=!1,e.removeClassName(this.container,c.disablePreviousMonth)):(this.disablePreviousMonth=!0,e.addClassName(this.container,c.disablePreviousMonth));if("today-past"===q.direction||"past"===q.direction)-11>=a?(this.disableNextYear=!1,e.removeClassName(this.container,c.disableNextYear)):(this.disableNextYear=!0,e.addClassName(this.container,c.disableNextYear));else if("today-future"===q.direction||"future"===q.direction)a>11+q.months?
(this.disablePreviousYear=!1,e.removeClassName(this.container,c.disablePreviousYear)):(this.disablePreviousYear=!0,e.addClassName(this.container,c.disablePreviousYear))}}};var v=function(a,b,c){var d=[];"string"===typeof a?a=a.split(b):e.isArray(a)||(a=[a]);b=a.length;var g=0,f;do a[g]&&(f=k(a[g],c).hours(12),f.isValid()&&d.push(f));while(++g<b);return d};window.Kalendae=n;var e=n.util={isIE8:function(){return!(!/msie 8./i.test(navigator.appVersion)||/opera/i.test(navigator.userAgent)||!window.ActiveXObject||
